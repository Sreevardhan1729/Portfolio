...
export const portfolioData = {
  personal: {
    ...
    resume: "https://drive.google.com/file/d/1A9pcq4ArSuREJSgF7hr9oVLg6hfgRolg/view?usp=sharing",
    social: {
  ...
  projects: [
    {
      ...
      technologies: ["Python", "Flask", "LangChain", "Docker", "AWS", "GitHub Actions"],
    ...
    },
    {
      ...
      githubUrl: "https://github.com/Sreevardhan1729/GuardianPulse-Family-Location-Insights",
    },
  ],
  ...
  achievements: [
    {
      ...
      description: "Secured a rating of 2077 (top 1.68%) on LeetCode, showcasing strong algorithmic problem-solving skills.",
      date: "Present",
      icon: "code",
    },
    {
