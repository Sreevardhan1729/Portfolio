  ...
  achievements: [
    {
      ...
      description:
        "Secured a rating of 2,077 (top 1.69%) on LeetCode, showcasing strong algorithmic problem-solving skills.",
      date: "Present",
      icon: "code",
    },
    {
      ...
      description:
        "Ranked 565 among over 47,000 global participants in the prestigious IICPC contest.",
      date: " ",
      icon: "trophy",
    },
    {
      ...
      description:
        "Earned a 4-star rating (max: 1,827) on CodeChef through consistent participation in weekly contests.",
      date: "Present",
      icon: "star",
    },
    {
      ...
      description:
        "Achieved Specialist rank on Codeforces with a max rating of 1,493.",
      date: "Present",
      icon: "star",
    },
    {
      title: "Project Lead",
      description:
        "Led a team of 6 in a Python project to successfully complete the online book exchanging system 'BookBridge'.",
      date: " ",
      icon: "users",
    },
  ],
