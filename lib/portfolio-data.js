...
export const portfolioData = {
  ...
  projects: [
    ...
    {
      title: "AI-Driven Wine Quality Analyzer",
      description: "Developed a complete ML pipeline for real-time wine quality prediction, deployed as a Flask web app on AWS EC2 using Docker and CI/CD.",
      image: "/placeholder.svg?height=300&width=500",
      technologies: ["Python", "Flask", "ML", "Docker", "AWS", "CI/CD"],
      githubUrl: "https://github.com/itssreevardhan/Wine-Quality-Prediction",
    },
    {
